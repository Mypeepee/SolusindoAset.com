...
import { serializeTypes } from "@/lib/propertyType";
...
const CardSlider = () => {
  ...
  const handleSearch = () => {
    ...
    if (typeParam) {
      ...
      // dikirim lewat `kategori`. Di Jual/Lelang, `tipe` memang = kategori.
      params.set(activeTab === "semua" ? "kategori" : "tipe", typeParam);
    }
  ...
  return (
    <div className="w-full max-w-6xl mx-auto font-sans relative z-30 zoom-safe" ref={wrapperRef}>
      ...
      <div className="flex justify-center mb-6">
        <div className="bg-[#1A1A1A]/90 backdrop-blur-md border border-white/20 px-3 py-2 rounded-full flex w-full max-w-md sm:max-w-none sm:w-auto sm:inline-flex shadow-xl">
          {[
            ...
            <motion.button
              ...
              onClick={() => {
                ...
                setFormData(prev => ({
                  ...prev,
                  types: prev.types.filter(t => PROPERTY_TYPES[newTab].includes(t)),
                }));
              }}
              whileTap={{ scale: 0.94 }}
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center divide-y lg:divide-y-0 lg:divide-x divide-gray-100">
          ...
          <div className="w-full lg:w-[13%] px-3 lg:px-4 py-4 lg:py-2.5 relative min-w-0">
            <TypePicker
              ...
              options={PROPERTY_TYPES[activeTab]}

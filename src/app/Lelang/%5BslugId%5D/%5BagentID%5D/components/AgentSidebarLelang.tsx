...
export default function AgentSidebar({ data, currentAgentId }: AgentSidebarProps) {
  const agentData = {
    id: data.owner?.id || "",
    name: data.owner?.name || "Agent Premier",
    avatar:
      data.owner?.avatar ||
      data.agent?.foto_url ||
      data.agent_photo ||
  ...
  console.log("🖼️ AgentSidebar Avatar Debug:", {
    avatarSrc,
    isValidImage,
    ownerAvatar: data.owner?.avatar,
    agentFotoUrl: data.agent?.foto_url,
    ...
    <>
      ...
      <div className="hidden lg:flex flex-col w-[380px] sticky top-28 h-fit bg-[#111111] rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] overflow-hidden">
              ...
              <div className="flex items-end gap-1">
                <span className="text-2xl font-extrabold text-white">
                  {new Intl.NumberFormat("id-ID", {
                    ...
                    currency: "IDR",
                    maximumFractionDigits: 0,
                  }).format(data.priceRates.monthly)}
                </span>
                {data.type === "Sewa" && (
        ...
        <div className="flex-1 overflow-y-auto px-6 py-2 custom-scrollbar space-y-4">
          ...
          <div className="bg-[#050505] rounded-xl p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1 mt-1 text-gray-400">
                ...
                <p className="text-xs truncate">
                  {agentData.office || "Kantor Tidak Diketahui"}
                </p>
              </div>
              <div className="flex items-center gap-2 mt-2">
                <span className="text-[10px] bg-green-500/15 text-green-400 px-2 py-0.5 rounded-full border border-green-500/30 font-bold">
                  Official Agent
                </span>
              </div>
            </div>
          ...
          {/* KOTAK 2: STATISTIK */}
          <div className="flex justify-between items-start bg-[#050505] rounded-xl p-3 px-2">
            <div className="flex flex-col items-center justify-center gap-1 flex-1 border-r border-white/10 px-1">
              <div className="flex items-center gap-1">
                ...
                <span className="text-sm font-bold text-white">
                  {Number(agentData.rating).toFixed(1)}
                </span>
              </div>
            ...
            <div className="flex flex-col items-center justify-center gap-1 flex-1 border-r border-white/10 px-1">
              <div className="flex items-center gap-1">
                <Icon
                  ...
                  className="text-[#86efac] text-sm shrink-0"
                />
          ...
          {/* KOTAK 3: INFO SAFETY */}
          <div className="relative w-full rounded-xl p-3 flex items-start gap-3 border border-dashed border-gray-700 bg-[#111111]">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 leading-tight">
                Hati-hati penipuan. Jangan transfer uang ke rekening pribadi
                agent.
              </p>
            </div>
          </div>
        ...
        {/* FOOTER */}
        <div className="p-6 pt-4 bg-[#111111] z-20 shrink-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="w-full bg-transparent border border-white/15 hover:bg-white/5 text-white font-bold text-sm py-3 rounded-xl transition-all flex justify-center items-center gap-2"
              >
                <Icon
      ...
      {/* MOBILE / TABLET */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#111111] border-t border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.7)]">
        <div className="px-4 py-3 flex items-center justify-between border-b border-white/5">
          ...
          <div className="flex flex-col items-end">
            <span className="text-[10px] font-bold text-[#86efac] uppercase">
              Harga
            </span>
        ...
        <div className="px-4 py-3 flex gap-2">
          ...
          <button
            onClick={() => handleContact("call")}
            className="bg-transparent border border-white/15 hover:bg.white/5 text.white font-bold text-sm py-3 px-4 rounded-xl transition-all flex justify-center items-center"
          >
            <Icon
              icon="solar:phone-calling-bold"
              className="text-xl"

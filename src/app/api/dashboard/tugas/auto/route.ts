    ...
    for (const lead of leads) {
      ...
      if (lead.status === "new") {
        ...
        tasks.push({
          ...
          why: urgent
            ? `Lead masuk ${ageMin} menit lalu, belum dihubungi. Respons < 30 menit naikan peluang 9×.`
            : `Lead baru masuk ${ageMin} menit lalu. Segera hubungi sebelum 30 menit.`,
        ...
        tasks.push({
          ...
          why: `Lead HOT ${h > 0 ? `${h} jam` : `${ageMin} menit`} tanpa aktivitas. Hubungi sekarang sebelum minat turun.`,
          overdue: urgent, leadName: name, leadPhone: lead.client_phone,

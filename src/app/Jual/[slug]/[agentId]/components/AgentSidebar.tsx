...
export default function AgentSidebar({ data }: AgentSidebarProps) {
  ...
  const fileId: string = owner.avatar || ""; // berisi Google Drive fileId

  // Jika ada fileId, gunakan thumbnail Google Drive
  // Kalau tidak ada, gunakan default lokal
  const avatarSrc = fileId
    ? `https://drive.google.com/thumbnail?id=${fileId}&sz=w128`
    : "/images/default-profile.png"; // pastikan file ini ada di public/images

  const isValidImage = !!avatarSrc;
  ...
  // 3. WHATSAPP LOGIC — capture lead dulu, baru redirect
  const handleContact = (type: "wa" | "call" | "schedule") => {
    ...
    // Tracking — fire-and-forget, jangan blocking redirect
    trackLeadClick({
      id_property: data.id_property,
      id_agent: data.owner?.id_agent,
      source,
    });
        ...
        <div className="flex-1 overflow-y-auto px-6 py-2 custom-scrollbar space-y-4">
          ...
          <div className="bg-[#0F0F0F] border border-white/10 rounded-xl p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items_center gap-1 mt-1 text-gray-400">
                <Icon
          ...
          <div className="flex justify-between items-start bg-[#0F0F0F] border border-white/10 rounded-xl p-3 px-2">
            ...
            <div className="flex flex-col items-center justify_center gap-1 flex-[1.2] px-1">
        ...
        <div className="p-6 pt-4 border-t border-white/10 bg-[#1A1A1A] z-20 shrink-0 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-[#25D366] hover:bg-[#1ebc57] text_black font-extrabold text-sm py-3.5 rounded-xl shadow-[0_0_20px_rgba(37,211,102,0.15)] hover:shadow-[0_0_25px_rgba(37,211,102,0.3)] transition-all active:scale-[0.98] flex justify-center items-center gap-2"
            >
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="w-full bg-transparent border border-white/20 hover:bg-white/10 text-white font-bold text-sm py-3 rounded-xl transition-all flex justify_center items-center gap-2"
              >
                <Icon

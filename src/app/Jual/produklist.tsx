              ...
              <div className="mt-16 flex justify-center">
                <nav className="flex items_center gap-2 bg-[#1A1A1A] p-2 rounded-full border border_WHITE/10 shadow-2xl">
                  ...
                  <button
                    ...
                    className="w-10 h-10 rounded-full flex items-center justify-center text-white hover:bg_WHITE/10 disabled:opacity-30 disabled:hover:bg-transparent transition-all"
                  >
                    <Icon

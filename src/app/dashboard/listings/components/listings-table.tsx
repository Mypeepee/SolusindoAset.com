                ...
                >
                  ...
                  <td className="px-2 py-3 align-top">
                    <Link href={detailHref}>
                      <div className="relative h-10 w-14 overflow-hidden rounded-md border border-white/10 bg-black/40">
                        {item.thumbnailUrl ? (
                        ...
                        <div
                          className="absolute inset-0 hidden items-center justify-center text-[10px] text-slate-500"
                          style={item.thumbnailUrl ? undefined : { display: "flex" }}
                        >

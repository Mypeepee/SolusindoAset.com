      ...
      >
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-1.5 pointer-events-none">
          <Icon
            ...
            className="text-primary text-xl drop-shadow-md"
          />
          <span className="font-extrabold text-white text-lg tracking-tight drop-shadow-md">
            Kosku<span className="text-primary">.com</span>
          </span>
        </div>
          ...
          <>
            ...
            >
              ...
              <div className="p-5 border-t border-white/10 space-y-3 bg-[#0F0F0F]">
                ...
                <button className="w-full py-3 rounded-xl bg-primary text-darkmode font-bold hover:bg-primary/90 transition-colors shadow-lg shadow-green-500/10 text-sm">
                  Daftar Sekarang
                </button>
              </div>
            </motion.div>
